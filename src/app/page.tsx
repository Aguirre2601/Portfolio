                ...
                <section className="h-screen flex flex-col items-center justify-center text-center px-8" id="Services">
                    <div className='px-6 md:px-12 lg:px-24 tracking-tight relative'>
                        <div className='flex flex-col items-center text-center mb-1 md:mb-16 '>
                            <h2 className='text-sm md:text-5xl text-transparent bg-clip-text bg-linear-to-br from-gray-100 via-gray-400 to-gray-200 font-satoshi font-normal p-4' data-aos={isMounted ? "fade-up" : undefined}>¿Buscas un perfil profesional que no genere deuda técnica?</h2>
                            ...
                            <div className='flex flex-col items-center gap-2  relative z-9 justify-center mt-6 md:flex-row md:gap-6' data-aos={isMounted ? "fade-up" : undefined}>
