  ...
  return (
    <StyledWrapper>
      <button className="button">
        ...
        <span className="text_button">Trabaja conmigo</span>
      </button>
    </StyledWrapper>
  );
}
...
const StyledWrapper = styled.div`
  ...
  .button {
    ...
    /* CORRECCIÓN AQUÍ: Usar sintaxis CSS pura, no Tailwind */
    pointer-events: auto; 
    z-index: 5;
  }
  ...
  .button::after {
    ...
    width: 100%;
    height: 100%;
    background-color: hsla(260 97% 27% / 0.75);
    background-image: radial-gradient(
      ...
      radial-gradient(at 22% 91%, hsla(266, 36%, 40%, 1) 0px, transparent 50%);
