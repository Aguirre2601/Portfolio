...
const StyledWrapper = styled.div`
  /* Cambia esto en tu StyledWrapper */
  .button {
    ...
    pointer-events: auto; /* CORRECCIÓN AQUÍ */
    z-index: 5;
  }
  ...
  .button::before {
    ...
    box-shadow: inset 0 0.5px hsl(0, 0%, 100%), inset 0 -1px 2px 0 hsl(0, 0%, 0%),
      ...
      0 0 0 calc(var(--active, 0) * 0.05rem) hsl(274, 89%, 58%);
  ...
  .button::after {
    ...
    background-image: radial-gradient(
      ...
      radial-gradient(at 100% 100%, hsla(268, 74%, 16%) 0px, transparent 50%),
      radial-gradient(at 22% 91%, hsla(268, 74%, 16%) 0px, transparent 50%);
